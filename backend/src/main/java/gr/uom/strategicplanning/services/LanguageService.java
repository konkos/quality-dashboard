...
public class LanguageService {
    ...
    private OrganizationLanguage createOrUpdateOrgLanguage(ProjectLanguage projectLanguage, Optional<OrganizationLanguage> organizationLanguageOptional, Organization org) {
        OrganizationAnalysis organizationAnalysis = org.getOrganizationAnalysis();
